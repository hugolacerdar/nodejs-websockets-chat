...
import { GetChatRoomByIdService } from "../services/GetChatRoomsById";
import { GetChatRoomByUsersService } from "../services/GetChatRoomsByUsersService";
...
io.on("connect", (socket) => {
  ...
  socket.on("start_chat", async (data, callback) => {
    ...
    const currentUser = await getUserBySocketIdService.execute(socket.id);
